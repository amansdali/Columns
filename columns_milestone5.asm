...
##############################################################################
    ...
    # Run the game.
main:
    jal dun_dun_dunnn_du_dun_dun_da_da_da
    # Initialize the game
...
# plays a sequence of notes for starting the game
dun_dun_dunnn_du_dun_dun_da_da_da:
    li $v0, 33
    li $a0, 64
    li $a1, 500
    li $a2, 67
...
# plays a sound effect when the skydiver lands
ouch:
    li $v0, 31
    li $a0, 88
    li $a1, 100
